			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-8 wow fadeIn" data-wow-delay="0.9s">
						<h3>Crafting Digital Experiences: Full Stack Web Developer Portfolio</h3>
						<h1>JAPS</h1>
						<h2 class="rotate">Backend, &AMP; Frontend, Graphic Designer </h2>
						<p>My expertise lies in crafting seamless experiences using technologies like native PHP and Nodejs with Express. </p>
